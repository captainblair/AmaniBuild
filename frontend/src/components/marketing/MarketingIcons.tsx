...
export function IconDiary({ className = "h-5 w-5" }: IconProps) {
  return (
...
export function IconProcurement({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
...
export function IconGift({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
      ...
      <path d="M12 8v13M7 8c0-2 1-3 3-3 1 0 2 1 2 2M17 8c0-2-1-3-3-3-1 0-2 1-2 2" />
...
export function IconCrown({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
      <path d="M3 18h18M4 14l2-8 4 4 4-6 4 6 2-8 1 8H4z" />
    </svg>
  );
}
...
export function IconCloud({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
...
export function IconHeadset({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
...
export function IconPin({ className = "h-3.5 w-3.5" }: IconProps) {
  return (
